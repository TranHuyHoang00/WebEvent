...
import { Table, Space, Modal, Divider, Button, Input, Popconfirm, Image, Upload } from 'antd';
...
class user extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            dataUser: {},
            dataUsers: [
                { id: '1', username: 'Jakene123', password: '12345', full_name: 'Jacky Ne', avatar: '1.png' },
                { id: '2', username: 'Ohio123', password: '12345', full_name: 'Jacky Ne 2', avatar: '2.png' },
                { id: '3', username: 'Jakene123', password: '12345', full_name: 'Jacky Ne', avatar: '1.png' },
                { id: '4', username: 'Ohio123', password: '12345', full_name: 'Jacky Ne 2', avatar: '2.png' },
            ],
            idUser: '',
        }
    }
            ...
            },
            {
                ...
                render: (avatar) =>
                    <div className='flex items-center justify-center'>
                        {avatar &&
                            <Image width={80} height={80} src={require(`../../../assets/images/${avatar}`).default} />
                        }
                    </div>
                ,
            },
            {
                title: 'FULLNAME', dataIndex: 'full_name', responsive: ['md'],
            ...
            },
            {
                ...
                render: (_, record) => (
                    <Space size="middle">
                        ...
                        <Popconfirm title="DELETE ?" okType='default' onConfirm={() => this.handleDelete(record.id)}>
                            <a><AiFillDelete /></a>
                        </Popconfirm>
                    </Space>
                ),
            ...
            <>
                ...
                <Modal title="ADD NEW" open={this.state.isOpenFormCreate}
                    ...
                    <div className='space-y-[10px]'>
                        ...
                        <div>
                            ...
                            <Input placeholder='Greater than 3 characters'
                                onChange={(event) => this.handleOnchangeInput(event, 'username')} />
                        </div>
                        <div>
                            <label>Password<span className='text-red-500'> *</span></label>
                            <Input.Password placeholder='Greater than 3 characters'
                                onChange={(event) => this.handleOnchangeInput(event, 'password')} />
                        </div>
                        <div>
                            <label>Password repeat<span className='text-red-500'> *</span></label>
                            <Input.Password placeholder='Greater than 3 characters'
                ...
                >
                    <div className='space-y-[10px]'>
                        ...
                        <div>
                            <label>Fullname<span className='text-red-500'> *</span></label>
                            <Input value={dataUser.full_name} />
                        </div>
                    </div>
                </Modal>
